    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">QA Categories</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/getDashBoardPage">Dashboard</a></li>
                            <li class="breadcrumb-item active">QA Categories</li>
                        </ol>
                    </div><!-- /.col -->
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody>
                                                @foreach ($QACategories as $category)
                                                ...
                                                <td>
                                                    <a href="{{ route('qa.category.edit', $category->id) }}" class="btn btn-warning">Edit</a>
                                                    <a href="javascript:void(0)" class="btn btn-danger deleteCategory" data-cid="{{ $category->id }}">Delete</a>
                                                    <a href="{{ route('qa.items.list', $category->id) }}" class="btn btn-info ">Items</a>
                                                </td>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        <br>
                                        <a href="{{ route('qa.category.create') }}" class="btn btn-primary float-right">Create</a>
                                    </div>
                                    <!-- /.box-body -->
                                </div>
