    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Trader Vouchers</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/getDashBoardPage">Dashboard</a></li>
                            <li class="breadcrumb-item active">Trader Vouchers</li>
                        </ol>
                    </div><!-- /.col -->
                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd tr-style createVoucher">
                                                    ...
                                                    <td>
                                                        <form action="{{ route('voucher-trader.store') }}" method="POST" id="createVoucher">
                                                            {{ csrf_field() }}
