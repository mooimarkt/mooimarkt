                            ...
                            <table border="0" cellspacing="0" class="mcnTextContentContainer" width="100%" style="min-width: 100% !important;background-color: #FAFAFA;">
                                <tbody><tr>
                                    <td valign="top" class="mcnTextContent" style="padding: 18px;color: #222222;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;">
                                        <span style="font-size:20px"><strong>You have successfully posted an ad!</strong></span><br>
<br>
...
<u><strong>Completed your ad</strong></u><br>
<br>
Hi {{ $user->name }},<br>
<br>
Your ad "<a href="{{ \App\Ads::getUrl($ads->id) }}" target="_blank">{{ $ads->adsName }}</a>" is already on the site.</span>
