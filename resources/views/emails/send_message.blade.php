...
<u><strong>You have a new message</strong></u><br>
<br>
Hi {{ $user->name }},<br>
<br>
You've received a new message about the ad: <a href="{{ url('/add-details/'.$ads->id) }}" target="_blank">{{ $ads->adsName }}</a></span>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            Kind regards,<br>
The&nbsp;<img data-file-id="809233" height="20" src="https://gallery.mailchimp.com/d67cd1ab98a3340f2b1b2bdfa/images/d81951d6-727c-4b62-975f-4fcac48039ba.png" style="border: 0px  ; width: 50px; height: 20px; margin: 0px;" width="50">&nbsp;Crew
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
