            ...
            <div class="profile_sidebar_row follow_user_row">
                <div class="wrap_user">
                    <ul class="follow_user_wrap">
                        ...
                        @endforeach
                        <li class="number">
                            {{ count($followers) ? count($followers) . Language::lang('&nbsp;followers') :  Language::lang('No followers') }}
                        </li>
                    </ul>
                    @if(count($followers))
                            ...
                            <div>
                                <a href="{{ route('profile.show', $follower->id) }}"
                                   style="display: flex; align-items: center">
                                    <img src="{{ $follower->getAvatarAttribute($follower->avatar) }}" alt="Avatar"
                                         style="max-width: 50px; margin-right: 20px; border-radius: 50%">
                                    <span>{{ ucwords($follower->name) }}</span>
                                </a>
                            </div>
                        </li>
                    @endforeach
